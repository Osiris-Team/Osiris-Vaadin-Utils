...
public class HLayoutScroll extends HLayout { // Was Div before, not sure if it works as vertical layout

    public HLayoutScroll() {
        preparePanel();
    }

    public HLayoutScroll(Component... children) {
        super(children);
        preparePanel();
    }
    ...
    public HLayoutScroll add2(Component... comp) {
        add(comp);
        return this;
    }
}
